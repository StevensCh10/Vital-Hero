...
const NavbarDonor = () => {
  ...
  const toggleRightOptions = (e: any) => {
    ...
    setModalPosition({
      top: buttonRect.bottom + window.scrollY,
      left: buttonRect.left - window.scrollX - 119,
    });
    ...
    <nav className="flex box-border w-full justify-between items-center p-[10px] mb-[1%]">
      <div className="flex items-center">
        ...
        >
          ...
          <div className={modalItemStyle}>
            <img className={modalImgStyle} src="/blood-donation.png"></img>
      ...
      <div className="flex items-center">
        ...
        >
          ...
          <div className={modalItemStyle}>
            <img className={modalImgStyle} src="/senha.png"></img>
            <Link className={linkStyle} to="/change-password">Alterar Senha</Link>
          </div>
          <div className={modalItemStyle}>
