...
const HomeDonor = () => {
  ...
  const pStyle =
    "m-0 mb-[0.25%] mt-[2%] text-xl md:text-lg md:font-semibold md:text-md";
      ...
      <div className="flex flex-col items-center m-0 min-h-[96vh]">
          ...
          <div className="ml-[2vw] w-full md:w-[80vw]">
            <ul className="list-disc list-inside">
              ...
              <li className={liStyle}>
                Menores de 18 anos precisam do consentimento do responsável
                legal.
              </li>
              <li className={liStyle}>
        ...
        <div className="flex flex-row m-0 w-full">
          <div className="flex flex-col items-center justify-center box-border w-full h-[200px] md:h-[260px]">
            ...
            <label className="w-[90%] text-center text-[#1a3744d3] lg:text-[1.6em] md:text-[1.1em] text-[0.71em]">
        ...
        <div className="hidden md:flex w-full mb-[3%]">
          ...
          <div className="px-5">
            <p className="opacity-95 text-[1.1em]">
              A doação de sangue é um gesto essencial que pode salvar vidas. É
              um processo simples e seguro, onde uma única doação pode fazer
              toda a diferença para pacientes em situações críticas, como
              cirurgias, tratamentos de câncer, complicações durante o parto e
              acidentes graves.
            </p>
            <p className="opacity-95 text-[1.1em]">
              Qualquer pessoa saudável, entre 18 e 69 anos, pode doar sangue
              após passar por uma triagem. A doação é rápida e indolor, e o
              sangue doado é testado, processado e armazenado adequadamente para
              uso em emergências médicas.
            </p>
            <p className="opacity-95 text-[1.1em]">
              Além de salvar vidas, a doação de sangue traz uma sensação de
              realização e satisfação para os doadores, sabendo que estão
              ajudando a comunidade e fazendo uma diferença positiva na vida de
              outras pessoas.
            </p>
            <p className="opacity-95 text-[1.1em]">
              Junte-se à causa da doação de sangue e seja parte dessa corrente
              de solidariedade e esperança. Sua doação pode ser a luz no fim do
              túnel para alguém que precisa desesperadamente de sangue.
              Lembre-se: uma única doação pode fazer toda a diferença.
            </p>
          </div>
        </div>
        <div className="flex flex-col justify-center items-center w-full mb-[3%] p-[1.5%] mt-5 md:mt-4 pb-4">
          ...
          {donationForm !== null && screening === null && (
            <label className="text-[1.1em]">
              Você ainda não preencheu sua triagem.
              <Link className="text-[#b80e14]" to={"/screening"}>
                {" "}
                CLIQUE AQUI{" "}
              </Link>
              para preencher.
          ...
          {donationForm !== null && screening !== null && (
            <label className="text-[1.1em]">
              ...
              <Link className="text-[#b80e14]" to={"/scheduling-donation"}>
                {" "}
                CLIQUE AQUI
              </Link>
            </label>
