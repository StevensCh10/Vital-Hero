...
public record DonorDTO(Long id, Scheduling scheduling, String name, String email, int age, String gender, String maritalStatus, String address, String phone, String bloodType, String role) implements UserDTO{
